...
## Corpus Check
- 356 files · ~262,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2222 nodes · 6969 edges · 99 communities (94 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08457ca5`
...
Cohesion: 0.15
Nodes (23): Column, DataTable(), CreateMedicoDialog(), CreateObraSocialDialog(), MedicoDetailDialog(), MergePatientDialog(), ObraSocialDetailDialog(), ObraSocialHistoryDialog() (+15 more)

### Community 1 - "Diálogos de Configuración"
Cohesion: 0.07
Nodes (60): RoleManagementProps, RoleWithDetails, HistoryList(), ObjectHistoryDialogProps, TimelineResponse, IdleWarningModalProps, Detalle, ETIQUETAS (+52 more)
...
Cohesion: 0.03
Nodes (68): AnalysisCategory, AnalysisPanel, ApiResponse, AppConfig, ApplicationInfo, AuditUser, AvailableAnalysis, BaseEntity (+60 more)

### Community 4 - "Forma de Pago y Facturación ARCA"
Cohesion: 0.11
Nodes (30): Persona, Props, CuentaElegible, FormaDePago(), Props, SelectorDeCuentaProps, BillingEntitySelectProps, CampoPrecioFijo() (+22 more)

### Community 5 - "Primitivas UI (sheet, accordion)"
Cohesion: 0.06
Nodes (42): BatchAction, BatchActionBar(), ActionButton(), PaperStatusChips(), PaperStatusChipsProps, ProtocolBillingRow(), ProtocolBillingRowProps, PendingProtocolToBill (+34 more)

### Community 6 - "Configuración de Análisis y Precios"
Cohesion: 0.08
Nodes (26): BillingEntitySelect(), Resultado, CreateObraSocialDialogProps, FormData, initialFormData, ValidationState, CuentaDeCobro, CuentasDeCobro() (+18 more)

### Community 7 - "Manejo de Errores de API"
Cohesion: 0.12
Nodes (29): initialValidation, ValidatedField, ValidationResult, ValidationState, CreatePatientForm(), CreatePatientFormProps, ValidatedField, ValidationResult (+21 more)
...
Cohesion: 0.07
Nodes (36): DialogHeading(), DialogHeadingProps, CreateMedicoDialogProps, FormData, ValidationState, ImportDataDialogProps, PlanDeDerivacion, TwoFactorDisableDialogProps (+28 more)

### Community 11 - "Diálogos de Reportes y Roles"
Cohesion: 0.19
Nodes (16): NavegadorDeDias(), Props, ActionButton(), Flag(), ProtocolsTable(), SeparadorDeDia(), aClaveDeDia(), comoFechaCorta() (+8 more)

### Community 12 - "Enrolamiento de Segundo Factor"
Cohesion: 0.09
Nodes (31): PanelDeContrasenaNueva(), PanelDeRecuperacion(), TransicionLateral(), groupSecret(), TwoFactorEnrollStep(), TwoFactorEnrollStepProps, TwoFactorRecoveryCodes(), TwoFactorRecoveryCodesProps (+23 more)
...
Cohesion: 0.10
Nodes (37): PermissionManagementProps, extractErrorMessage(), UserManagementProps, extractErrorMessage(), CreateUserDialog(), CreateUserDialogProps, extractErrorMessage(), DeletePatientDialogProps (+29 more)
...
Cohesion: 0.19
Nodes (14): formatDateTime(), formatRemaining(), TrustedDeviceRow(), TWO_FACTOR_STATUS_KEY, TwoFactorSection(), TwoFactorSetupDialog(), twoFactorQueryKey(), UserTwoFactorPanel() (+6 more)

### Community 17 - "Tarjetas de Perfil y Paciente"
Cohesion: 0.19
Nodes (13): analysisCategoryLabels, esUnNumero(), formatNamedReferenceRange(), formatReferenceBounds(), formatReferenceGroup(), formatReferenceRange(), LimitesDelRango, referenceGroupLabels (+5 more)
...
Cohesion: 0.13
Nodes (19): AuditAvatars(), AnalysisDetailDialog(), AnalysisHistoryDialog(), AnalysisHistoryDialogProps, AnalysisList(), AnalysisSelector(), CopiarDeterminaciones(), CreateAnalysisCatalogDialog() (+11 more)

### Community 20 - "Selección de Análisis en el Ingreso"
Cohesion: 0.08
Nodes (39): CarruselDeslizable(), PaginatedResponse, CreateMedicoForm(), extractErrorMessage(), CreateObraSocialForm(), CreateObraSocialFormProps, EditObraSocialDialog(), EditDoctorInlineForm() (+31 more)

### Community 21 - "Alta de Paciente y DNI"
Cohesion: 0.22
Nodes (5): RequestLogPanel(), RequestLogPanelProps, STATUS_FILTERS, SUPERADMIN_ENDPOINTS, RequestLogResponse

### Community 22 - "Avatares de Auditoría y Tablas"
Cohesion: 0.33
Nodes (4): InputUnidadDeMedida(), Props, aSupraindice(), SUPRAINDICES

### Community 23 - "Título de Pestaña y Cola"
Cohesion: 0.67
Nodes (3): CreateDeterminationDialogProps, EditDeterminationDialogProps, Determination

### Community 24 - "Menús Desplegables y Acciones en Lote"
Cohesion: 0.05
Nodes (56): colorFor(), getInitials(), InitialsAvatar(), InitialsAvatarProps, PALETTE, sizes, NextInQueuePill(), NextInQueuePillProps (+48 more)

### Community 25 - "Entidades de Facturación"
Cohesion: 0.08
Nodes (28): BatchActionBarProps, ProtocolActions(), isDefaultReportSelected(), isSelectableForReport(), ProtocolCardProps, ReportAction, ReportProtocolDetail, AuditDialog() (+20 more)

### Community 26 - "Filtros de Estado de Protocolo"
Cohesion: 0.07
Nodes (30): useProtocolQuickActions(), CONTINGENCY_ENDPOINTS, PROTOCOL_ENDPOINTS, REPORTING_ENDPOINTS, PERMISSION_MESSAGES, PermissionDescriptor, PermissionKey, PERMISSIONS (+22 more)
...
Cohesion: 0.08
Nodes (22): SessionNotificationToggle(), SessionNotificationToggleProps, AuthContext, AuthProvider(), AuthProviderProps, ConfirmTwoFactorEnrollmentParams, EXPIRED_TOKEN_CODES, LoginOutcome (+14 more)

### Community 31 - "Pantalla de Configuración"
Cohesion: 0.12
Nodes (21): CATEGORY_META, HistoryListProps, ACTION_LABEL, AuditCard(), AuditCardProps, formatActionName(), getActionBadgeVariant(), getActionBorderColor() (+13 more)

### Community 32 - "Utilidades"
Cohesion: 0.14
Nodes (12): AuditTimelineMini(), AuditTimelineMiniProps, ListaOrdenable(), Props, orderStatusInfo(), ProtocolDetailView(), ProtocolDetailViewProps, Row() (+4 more)
...
Cohesion: 0.13
Nodes (15): PaginatedResponse, BLOCKS_KEY(), SecurityBlocksPanel(), BillingManagement(), CONFIG_TABS, SignaturesManagement(), formatBytes(), formatMs() (+7 more)

### Community 35 - "Tipos Compartidos"
Cohesion: 0.38
Nodes (8): Props, CampoNotacionCientifica(), Props, conSeparadores(), esExponenteValido(), expandirNumero(), superindice(), unidadCompleta()

### Community 37 - "Componentes de la App (2)"
Cohesion: 0.10
Nodes (18): ALCANCES, CeldaDelMes, Comparacion, DashboardResponse, EstadisticasDelMes, getTrendTone(), Home(), MesDisponible (+10 more)

### Community 38 - "Validación de Resultados"
Cohesion: 0.16
Nodes (15): ALLOWED_PROTOCOL_STATUS_FILTERS, fallbackProtocolStatusStyle, getProtocolStatusBadgeClass(), getProtocolStatusButtonClass(), getProtocolStatusStyle(), getProtocolStatusStyleByName(), normalizeProtocolStatusName(), PROTOCOL_STATUS_ID_BY_NAME (+7 more)

### Community 39 - "Componentes de la App (3)"
Cohesion: 0.09
Nodes (22): ManagementPage(), BillingBoard(), BoardRow, BoardState, STATE_TABS, CajaDelDia, dia(), plata() (+14 more)
...
Cohesion: 0.11
Nodes (16): CorreccionDelCobro(), plata(), Props, FilaAgrupada, haceDias(), hoyISO(), LibroDiarioPage(), Orden (+8 more)
...
Cohesion: 0.28
Nodes (14): ProtocolDetailResponse, ProtocolDetailViewData, ProtocolDetailsSection(), ProtocolDetailsSectionProps, ProtocolSuccess(), PreauthorizationDialogProps, getTrajoOrdenInfo(), getPaymentStatusInfo() (+6 more)
...
Cohesion: 0.22
Nodes (14): PermissionManagement(), alignClass, DataTableProps, SortDirection, AnalysisTableProps, QuoteDetail, Table(), TableBody() (+6 more)

### Community 49 - "Ingreso de Pacientes"
Cohesion: 0.07
Nodes (41): AnalysisDetailDialogProps, AnalysisSearch(), AnalysisSearchProps, buscarCoincidenciaDeCodigo(), PaginatedResponse, AnalysisSelectorProps, AnalysisTable(), Props (+33 more)

### Community 50 - "Hooks de Datos"
Cohesion: 0.17
Nodes (17): ClosePresentationDialog(), CurrentInvoicesList(), EditableCloseDate(), EditableCloseDateProps, formatCurrency(), PresentationEarningsChart(), RANGE_OPTIONS, RangeFilter (+9 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (34): Cambio, Confirmación de redondeo y refresco del protocolo, Deploy, Pedido, Validación, Backend asociado, Cambio, Diagnóstico de permisos y API (+26 more)
...
Cohesion: 0.09
Nodes (25): CreateMedicoFormProps, EditMedicoDialogProps, MedicoComboboxProps, PaginatedResponse, MedicoDetailDialogProps, PaginatedResponse, Medico, Command() (+17 more)

### Community 55 - "Utilidades (5)"
Cohesion: 0.24
Nodes (6): SortState, ProtocolsTableProps, ResultsQueueTableProps, ListState, PersistedShape, ProtocolListItem

### Community 56 - "Utilidades (6)"
Cohesion: 0.12
Nodes (18): BuscadorDeUb(), Props, CampoUbPorNomencladorProps, EditAnalysisCatalogDialog(), ObraSocialCombobox(), PropagarPreciosDialog(), CreateMode, emptyCreateForm (+10 more)
...
Cohesion: 0.38
Nodes (4): Campos, VACIA, teclaDelEvento(), MacroDeResultado

### Community 59 - "Utilidades (7)"
Cohesion: 0.11
Nodes (22): BillingEntityCard(), BillingEntityCardProps, EntityPatch, formatCloseDays(), ClosePresentationDialogProps, EditableAmount(), EditableAmountProps, formatCurrency() (+14 more)
...
Cohesion: 0.20
Nodes (10): API_CONFIG, LoteAdelantado, PaginatedPage, UseApiInfiniteQueryParams, guardarOrdenDeLaLista(), leerOrden(), mismaApi(), Orden (+2 more)
...
Cohesion: 0.13
Nodes (20): AuditAvatarsProps, AuditInfo, sizeClasses, textSizeClasses, ActionButtonProps, IconAction(), PatientsTable(), getStateColor() (+12 more)

### Community 68 - "Pantalla de Protocolos (5)"
Cohesion: 0.20
Nodes (9): EditFormData, ORDER_STATUS_OPTIONS, OrderStatusDialog(), OrderStatusDialogProps, isTrajoOrdenCompleta(), normalizeTrajoOrden(), TRAJO_ORDEN, TRAJO_ORDEN_OPTIONS (+1 more)
...
Cohesion: 0.23
Nodes (14): fmtDateTime(), ResultDeterminationRow(), ResultDeterminationRowProps, fmtDateTime(), ValidationResultRow(), ValidationResultRowProps, ResultGroup, ResultValue (+6 more)
...
Cohesion: 0.17
Nodes (22): CurrentInvoicesListProps, Analysis, DeleteAnalysisCatalogDialogProps, DeleteDeterminationDialogProps, DeterminationItem, DeleteMedicoDialogProps, Medico, ProtocolActionsProps (+14 more)
...
Cohesion: 0.10
Nodes (32): RoleManagement(), UserManagement(), MovimientoDeCajaDialog(), ObjectHistoryDialog(), AnalysisCatalog, AnalysisListProps, CambioDeContrasenaObligatorio(), CreateDeterminationDialog() (+24 more)
...
Cohesion: 0.36
Nodes (8): formatUtcDate(), palabrasDe(), resaltar(), sinTildes(), Trozo, getProtocolStatusBadgeClassByName(), ConResaltado(), SearchResultCard()

### Community 106 - "Community 106"
Cohesion: 0.18
Nodes (16): getIdleTimeFromUser(), minutoDelDia(), minutosDeInactividadAhora(), minutosDeLaHora(), msDeInactividadAhora(), msHastaElProximoBorde(), rangosDe(), resolveIdleMinutes() (+8 more)
...
Cohesion: 0.40
Nodes (4): Análisis y contrato, Autor visible en el libro diario, Diseño → pruebas → implementación, Estado
...
## Knowledge Gaps
- **715 isolated node(s):** `type`, `$schema`, `style`, `rsc`, `tsx` (+710 more)
...
- **Why does `cn()` connect `Primitivas UI (sheet, accordion)` to `Diálogos y Tarjetas de Protocolo`, `Diálogos de Configuración`, `Forma de Pago y Facturación ARCA`, `Configuración de Análisis y Precios`, `Manejo de Errores de API`, `Configuración de Endpoints`, `Diálogos de Reportes y Roles`, `Enrolamiento de Segundo Factor`, `Campos de Formulario`, `Valores de Referencia y Determinaciones`, `Búsqueda Global`, `Selección de Análisis en el Ingreso`, `Avatares de Auditoría y Tablas`, `Menús Desplegables y Acciones en Lote`, `Pantalla de Configuración`, `Utilidades`, `Componentes de la App`, `Componentes de la App (3)`, `Pantalla de Protocolos (2)`, `Permisos de Configuración de la API`, `Componentes UI Base`, `Hooks de Datos`, `Componentes UI Base (3)`, `Utilidades (5)`, `Utilidades (7)`, `Community 63`, `Pantalla de Protocolos (3)`, `Pantalla de Protocolos (4)`, `Community 75`, `Componentes Compartidos (6)`, `Community 90`, `Community 94`, `Community 100`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `Button()` connect `Diálogos de Configuración` to `Diálogos y Tarjetas de Protocolo`, `Forma de Pago y Facturación ARCA`, `Primitivas UI (sheet, accordion)`, `Configuración de Análisis y Precios`, `Manejo de Errores de API`, `Configuración de Endpoints`, `Diálogos de Reportes y Roles`, `Enrolamiento de Segundo Factor`, `Valores de Referencia y Determinaciones`, `Presentaciones y Gráficos de Facturación`, `Búsqueda Global`, `Caja del Día y Pendientes`, `Selección de Análisis en el Ingreso`, `Alta de Paciente y DNI`, `Avatares de Auditoría y Tablas`, `Menús Desplegables y Acciones en Lote`, `Filtros de Estado de Protocolo`, `Pantalla de Configuración`, `Utilidades`, `Componentes de la App`, `Componentes de la App (3)`, `Componentes de la App (4)`, `Pantalla de Configuración (2)`, `Permisos de Configuración de la API`, `Componentes UI Base`, `Ingreso de Pacientes`, `Hooks de Datos`, `Componentes UI Base (3)`, `Utilidades (6)`, `Pantalla de Configuración (4)`, `Utilidades (7)`, `Pantalla de Protocolos (3)`, `Pantalla de Protocolos (4)`, `Pantalla de Protocolos (5)`, `Community 75`, `Componentes Compartidos (6)`, `Community 94`, `Community 106`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `useApi()` connect `Community 94` to `Diálogos y Tarjetas de Protocolo`, `Diálogos de Configuración`, `Forma de Pago y Facturación ARCA`, `Configuración de Análisis y Precios`, `Manejo de Errores de API`, `Configuración de Endpoints`, `Enrolamiento de Segundo Factor`, `Valores de Referencia y Determinaciones`, `Presentaciones y Gráficos de Facturación`, `Búsqueda Global`, `Caja del Día y Pendientes`, `Selección de Análisis en el Ingreso`, `Menús Desplegables y Acciones en Lote`, `Entidades de Facturación`, `Filtros de Estado de Protocolo`, `Pantalla de Configuración`, `Componentes de la App`, `Componentes de la App (3)`, `Componentes de la App (4)`, `Pantalla de Configuración (2)`, `Componentes UI Base`, `Ingreso de Pacientes`, `Hooks de Datos`, `Componentes UI Base (3)`, `Utilidades (6)`, `Pantalla de Configuración (4)`, `Utilidades (7)`, `Hooks de Datos (2)`, `Pantalla de Protocolos (3)`, `Hooks de Datos (5)`, `Componentes Compartidos (6)`, `Community 106`?**
